...
# from langchain.memory import ConversationBufferMemory does not work with ConversationalRetrievalChain
...
def process_user_query(question, vector_db,chat_history):
    ...
    formated_chat_history =  [(item['question'],item['answer']) for item in chat_history]

    # Get response from the conversation chain
    response = chain({"question": question, "chat_history": formated_chat_history})
    return response
